...
- **観点A**: 全30問を本文だけを根拠に自力で解く。解けない/曖昧/正解キー誤りは書き直す。
...
## 4. チャンク抜き取り
10本すべてを `chunkText` に通し、語中分割だけでなく「連体修飾だけが孤立して意味が閉じないチャンク」がないか目視。異常があれば**チャンカーのバグ**としてnotesに記録（QAではindex.htmlを改変せず、機能改善へ申し送る）。
